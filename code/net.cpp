								 ...
								 void* userp, bool is_header)
{
	if (!is_header)
	{
		...
		while (true)
		{
			auto [line_start, line_len] = find_next_line(buffer);
...
// net::request
net::request::request(const net::url& req_url)
	: req_url(req_url), method(net::http_method::HTTP_METHOD_NULL), headers{}
{
}
...
net::request::request(const net::url& req_url, net::http_method method)
	: req_url(req_url), method(method), headers{}
{
}

net::request::request(const std::string& url_string, net::http_method method)
	: request(net::url(url_string), method)
{
}

net::request::request(
	const net::url& req_url, net::http_method method,
	const std::unordered_map<std::string, std::string>& headers)
	: req_url(req_url), method(method), headers(headers)
{
}

net::request::request(
	const std::string& url_string, net::http_method method,
	const std::unordered_map<std::string, std::string>& headers)
	: request(net::url(url_string), method, headers)
{
}
...
net::request::request(
	...
	const std::unordered_map<std::string, std::string>& headers,
	const nlohmann::json&								json_data)
	: request(net::url(url_string), method, headers, json_data)
{
}
